"""Run official Quito CLI DLinear 96_48_S finetuning.
...
DEFAULT_CONFIG_PATH = Path("configs/finetune/dlinear/96_48_S.yaml")
...
def _latest_output_dir(quito_root: Path) -> Path | None:
    base = quito_root / "outputs" / "dlinear" / "96_48_S" / "FINE_TUNE"
    if not base.exists():
        return None
